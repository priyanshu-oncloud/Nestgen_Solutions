  ...
  const deleteCareer = async (id: string) => {
    ...
    try {
      ...
      if (record?.resumeUrl) {
        ...
        // Works even if resumeUrl is a download URL
      ...
      toast({ title: "Career application & resume deleted" });
    } catch (err) {
      console.error(err);
      toast({
        title: "Delete failed",
        description: "File or data could not be deleted",
        variant: "destructive",
      });
    }
  };
